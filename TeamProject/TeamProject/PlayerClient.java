...
public setguessLetterControl(SwitchPlayer SwitchPlayer) {this.guessLetterControl = guessLetterControl;}
public setSwitchPlayer(SwitchPlayer SwitchPlayer) {this.SwitchPlayer = SwitchPlayer;}
...
protected void handleMessageFromServer(Object arg0)
{
  ...
  {
    cl.show(container, "2");    //CreateAccount -> Login screen
