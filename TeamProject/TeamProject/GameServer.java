...
public class GameServer extends AbstractServer
{
  ...
  protected void handleMessageFromClient(Object arg0, ConnectionToClient arg1)
  {
    ...
    {
      ServerCategoryData.setCategoryData (CategoryData);  //client sent selected category
    ...
    {
      GuessLetterData.setGuessLetterData(GuessLetterData);  //server received GuessLetterData from client and process
      arg1.sendToClient(GuessLetterData);                   //server send the processed GuessLetterData back to client
    }
